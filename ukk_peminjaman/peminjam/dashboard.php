...
<h4 class="mb-4 fw-bold">👋 Dashboard Peminjam</h4>
...
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <div class="card shadow-sm border-0 rounded-4 text-center">
            <div class="card-body">
                ...
                <h2 class="fw-bold text-primary"><?= $aktif ?></h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm border-0 rounded-4 text-center">
            <div class="card-body">
                <h6 class="text-muted">📤 Ajukan Peminjaman</h6>
                <a href="pinjam.php" class="btn btn-primary rounded-pill px-4 mt-2">
                    Pinjam Alat
                </a>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm border-0 rounded-4 text-center">
            <div class="card-body">
                ...
                <a href="kembali.php" class="btn btn-warning rounded-pill px-4 mt-2">
                    Kembali Alat
                </a>
            </div>
        </div>
